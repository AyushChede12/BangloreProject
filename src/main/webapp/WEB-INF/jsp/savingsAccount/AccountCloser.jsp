	...
	<form method="post" action="accountCloser" id="form1">
		<div
			...
			<div class="content-wrapper" style="min-height: 1105.75px;">
				<section class="content-header">
					...
					<h5 style="margin-left: 18px;">SAVING A/C CLOSER</h5>
					<ol class="breadcrumb">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-success form-container"
								...
								<div class="box-body">
									<div class="col-md-3" style="margin-top: 15px;">
										...
										<label for="ddlDebitSelectAccountNo">Select Acc.No.<strong
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label>Mobile Numder<strong style="color: Red">*</strong></label>
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label>Opening Branch<strong style="color: Red">*</strong></label>
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtCurrentBalance">Current Balance<strong
											style="color: Red">*</strong>
										</label> <input name="avaBalance" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtTotalInterestPaid">Paid Interest<strong
											style="color: Red">*</strong>
										</label> <input name="paidInterest" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtInterestDue">Interest Due<strong
											style="color: Red">*</strong>
										</label> <input name="interestDue" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtNetAmount">Net Amount<strong
											style="color: Red">*</strong>
										</label> <input name="netAmount" type="text" readonly="readonly"
							...
							<div class="box box-info form-container"
								id="paymentDetailsSection" style="display: none;">
								<div class="box-header">
								...
								<div class="box-body">
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="ddlClosingBranchName">Closing Branch<strong
											style="color: Red">*</strong>
										</label> <select name="branchName1" id="branchName1"
											class="form-control select2" style="width: 100%;">
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label>Closing Date<strong style="color: Red">*</strong></label>
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="drpPaymentBy">Payment By <strong
											style="color: Red">*</strong>
										</label> <select name="paymentBy" id="paymentBy" class="form-control"
											style="width: 100%;">
		...
		<script type="text/javascript">
			...
			var Page_Validators = new Array(
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorDebitSelectAccountNo"),
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorDebitMemberNo"),
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatortxtMobileNumber"),
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatortxtOpeningBranch"),
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatortxtOpeningDate"),
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorCurrentBalance"),
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorTotalInterestPaid"),
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorInterestDue"),
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorNetAmount"));
			//]]>
		</script>

		<script type="text/javascript">
			//<![CDATA[
			var ContentPlaceHolder1_RequiredFieldValidatorDebitSelectAccountNo = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatorDebitSelectAccountNo"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorDebitSelectAccountNo");
			...
			var ContentPlaceHolder1_RequiredFieldValidatorDebitMemberNo = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatorDebitMemberNo"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorDebitMemberNo");
			...
			var ContentPlaceHolder1_RequiredFieldValidatortxtMobileNumber = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatortxtMobileNumber"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatortxtMobileNumber");
			...
			var ContentPlaceHolder1_RequiredFieldValidatortxtOpeningBranch = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatortxtOpeningBranch"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatortxtOpeningBranch");
			...
			var ContentPlaceHolder1_RequiredFieldValidatortxtOpeningDate = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatortxtOpeningDate"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatortxtOpeningDate");
			...
			var ContentPlaceHolder1_RequiredFieldValidatorCurrentBalance = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatorCurrentBalance"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorCurrentBalance");
			...
			var ContentPlaceHolder1_RequiredFieldValidatorTotalInterestPaid = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatorTotalInterestPaid"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorTotalInterestPaid");
			...
			var ContentPlaceHolder1_RequiredFieldValidatorInterestDue = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatorInterestDue"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorInterestDue");
			...
			var ContentPlaceHolder1_RequiredFieldValidatorNetAmount = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatorNetAmount"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorNetAmount");
		...
		<script type="text/javascript">
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatorDebitSelectAccountNo').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatorDebitMemberNo').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatortxtMobileNumber').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatortxtOpeningBranch').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatortxtOpeningDate').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatorCurrentBalance').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatorTotalInterestPaid').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatorInterestDue').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatorNetAmount').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
