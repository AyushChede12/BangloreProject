...
<body class="skin-blue sidebar-mini" onload="GetBranchNameInTheDropDown();"
	...
	<!--     <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/LoanNotApproveReport.aspx" id="form1"> -->
	...
	<div
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			...
			<section class="content-header">
				<h1 id="ContentPlaceHolder1_IdHeader">Loan Application Report</h1>
				<ol class="breadcrumb">
						...
						<div class="box box-info">
							...
							<div class="box-body">
								...
								<div class="col-md-2">
									<div class="form-group">
										<label></label>
											<button onclick=" getLoanNotApprove();"
						...
						<div class="box box-success"
							...
							<div class="box-body">
								...
								<table cellspacing="0" cellpadding="3" rules="all"
									...
									<caption>LoanNotApproveReport</caption>
...
<!-- Dk/Admin/LoanNotApproveReport.aspx EDB D 09:27:21 GMT -->
</html>
