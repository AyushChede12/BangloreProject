...
<body class="skin-blue sidebar-mini"
	...
	<!--     <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/RecurringDueReport.aspx" id="form1"> -->
	...
	<div
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			...
			<section class="content-header">
				...
				<h5 style="margin-left: 18px;">RECURRING INSTALLMENT DUE REPORT</h5>
				<ol class="breadcrumb">
						...
						<div class="box box-success form-container">
							...
							<div class="box-body">
								...
								<div class="col-md-12 text-center" style="margin-top: 15px;">
									...
									<label></label>
									<button type="submit" onclick="getbetdate();"
	...
	<!--         Fetchrecord -->
	<script src="dist/js/RecurringDuejs.js"></script>
	<script src="dist/js/GetAllBranch.js"></script>
	<!--     </form> -->
</body>

<!-- Dk/Admin/RecurringDueReport.aspx EDB D 09:27:21 GMT -->
</html>
