...
<body class="skin-blue sidebar-mini" onload="GetBranchNameInTheDropDown();"
	...
	<!-- <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/EMICollectonReport.aspx?Type=I" id="form1"> -->
	...
	<div
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			...
			<section class="content-header">
				<h1 id="ContentPlaceHolder1_IdHeader">Irregular EMI Report</h1>
				<ol class="breadcrumb">
					...
					<div class="col-xs-12">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<button id="btnSearch" class="btn btn-success margin-20"
											onclick="IrregularEMIReportAjax();">
						...
						<div class="box box-success"
							...
							<div class="box-header with-border">
								...
								<div>
									<h5 style="text-align: center; font-weight: bold;">EMI
	...
	<script src="dist/js/IrregularEMIReport.js"></script>
	<script src="dist/js/GetAllBranch.js"></script>

	<!--  </form> -->
</body>

<!-- Dk/Admin/EMICollectonReport.aspx?Type=I EDB D 09:27:21 GMT -->
</html>
