...
<body class="skin-blue sidebar-mini"
	...
	<!--     <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/ProjectionReport.aspx" id="form1"> -->
	...
	<div
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			...
			<section class="content-header">
				...
				<h5 style="margin-left: 18px;">JOINT LIABILITY DOCUMENT</h5>
				<ol class="breadcrumb">
						...
						<div class="box box-info form-container">
							...
							<div class="box-body">
								...
								<div class="col-md-12 text-center" style="margin-top: 15px;">
									...
									<label></label>
									<button type="submit" onclick="getProjectionREport();"
						...
						<div class="box box-success form-container"
							...
							<div class="box-body">
								...
								<table cellspacing="0" cellpadding="3" rules="all"
									...
									<caption>Loan Outstanding Report</caption>
...
<!-- Dk/Admin/ProjectionReport.aspx EDB D 09:27:22 GMT -->
</html>
