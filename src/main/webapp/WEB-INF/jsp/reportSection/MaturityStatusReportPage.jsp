...
<body class="skin-blue sidebar-mini"
	...
	<!--     <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/MaturityStatusReport.aspx" id="form1"> -->
	<div
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			...
			<section class="content-header">
				...
				<h5 style="margin-left: 18px;">MATURITY STATUS REPORT</h5>
				<ol class="breadcrumb">
					<li><a href="Home.html"><i class="fa fa-dashboard"></i>Home</a></li>
					<li><a href="#">Dashboard</a></li>
					<li class="active">Maturity Status</li>
				</ol>
			</section>
						...
						<div class="box box-success form-container">
							...
							<div class="box-body">
								...
								<div class="col-md-12 text-center" style="margin-top: 15px;">
									...
									<label></label>
									<button type="submit" onclick="getmaturityStatus();"
	...
	<!--         Fetchrecord -->
	<script src="dist/js/Maturitystatusjs.js"></script>
	<script src="dist/js/GetAllBranch.js"></script>
	<!--     </form> -->
</body>

<!-- Dk/Admin/MaturityStatusReport.aspx EDB D 09:27:22 GMT -->
</html>
