...
<body class="skin-blue sidebar-mini"
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			...
			<div class="wizard-steps">
				<div class="wizard-step active" id="step1">
					...
					<div class="step-title">Advisor/Collector Details</div>
								...
								<div class="form-container">
											...
											<div class="col-md-3">
												...
												<div class="col-sm-5">
													<input name="age" type="text" maxlength="2" id="age"
														class="form-control" Placeholder="Enter Age" /> <span
											...
											<div class="col-md-3">
												...
												<div class="col-sm-8">
													<input name="state" type="text" Placeholder="Enter State"
														id="state" class="form-control" /> <span id="state"
														style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Select
														State</span>
												</div>
											</div>
									...
									<div class="clearfix">
										<button type="button" class="btn btn-primary pull-right"
											onclick="goIntoducer()">NEXT</button>
									</div>
								</div>
							</form>
						</div>

						<div class="form-container" id="introducerDetails"
							style="display: none;">
							<div class="box-header">
							...
							<div class="box-body form-horizontal">
								...
								<div class="row four-field-row">
									...
									<div class="col-md-3">
										...
										<div class="col-sm-8">
											<input name="introducerName" type="text" id="introducerName"
												class="form-control" Placeholder="Enter Introducer Name" />
								...
								<div class="clearfix">
									<button type="button" class="btn btn-default"
										onclick="backAdvisor()">PREVIOUS</button>
									<button type="button" class="btn btn-primary pull-right"
							...
							<div class="box-body form-horizontal">
								...
								<div class="row four-field-row">
									...
									<div class="col-md-3">
										...
										<div class="col-sm-8">
											<input name="feesIfAny" type="text" value="" id="feesIfAny"
												class="form-control"
												onkeypress="return isNumberOnlyKey(this, event);" /> <span
								...
								<div class="clearfix">
									<button type="button" class="btn btn-default"
										onclick="backIntoducer()">PREVIOUS</button>
									<input type="button" name="ctl00$ContentPlaceHolder1$btnDelete"
										value="Delete" onclick="softDeleteForAdvisorRectification();"
										id="ContentPlaceHolder1_btnDelete"
										class="btn btn-danger pull-right" /> <input type="button"
										name="ctl00$ContentPlaceHolder1$btnSave" value="Update"
	...
	<script>
function goIntoducer() {
	$("#advisorDetails").hide();
	$("#introducerDetails").show();
