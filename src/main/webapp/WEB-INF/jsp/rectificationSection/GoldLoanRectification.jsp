...
<body class="skin-blue sidebar-mini"
	...
	<div
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			...
			<section class="content-header">
				...
				<h5 style="margin-left: 18px;">GOLD LOAN CORRECTION</h5>
				<ol class="breadcrumb">
			...
			<div class="wizard-steps">
				...
				<div class="wizard-step inactive" id="step2">
					...
					<div class="step-title">Gold Silver Details </div>
				</div>
				...
				<section class="content">
					<div id="ContentPlaceHolder1_idSearch" class="row">
						<div class="col-md-12">
								...
								<div class="form-container">
									...
									<div class="box-body form-horizontal">
										<div class="row four-field-row">
											...
											<div class="col-md-3">
												<label class="col-sm-4 control-label">Select Member
										...
										<div class="clearfix">
											<button type="button" class="btn btn-primary pull-right"
												onclick="gogoldsilverDetails()">NEXT</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="form-container" id="goldsilverDetails" style="display: none;">
								<div class="box-header">
								...
								<div class="box-body form-horizontal">
									<div class="row four-field-row">
										...
										<div class="col-md-3">
											...
											<div class="col-sm-4">
												<select name="itemType" onchange="" id="itemType"
													class="form-control" style="width: 100%;">
													<option selected="selected" value="">--Select Item
														Type--</option>
										...
										<div class="col-md-3">
											<label class="col-sm-4 control-label">Locker Location
												<strong style="color: Red">*</strong>
											</label>
											<div class="col-sm-8">
												<select name="lockerLoc" id="lockerLoc" class="form-control"
													style="width: 100%;">
													<option selected="selected" value="">--Select
									...
									<div class="row four-field-row">
										<div class="col-md-3">
											<label class="col-sm-3 control-label">Net Qty. <strong
												style="color: Red">*</strong></label>
											<div class="col-sm-3">
												<input name="netQty" type="text" placeholder="Enter"
													readonly="readonly" id="netQty" class="form-control" />
											</div>
										</div>

										<div class="col-md-3">
											<label class="col-sm-4 control-label">Total Item Wt.
												<strong style="color: Red">*</strong>
											</label>
											<div class="col-sm-8">
												<input name="totItemWt" placeholder="Enter" type="text"
													readonly="readonly" id="totItemWt" class="form-control" />
											</div>
										</div>

										<div class="col-md-3">
											<label class="col-sm-4 control-label">Total Net Wt.</label>
											<div class="col-sm-8">
												<input name="totalNetWt" placeholder="Enter" type="text"
													readonly="readonly" id="totalNetWt" class="form-control" />
											</div>
										</div>
										<div class="col-md-3">
											<label class="col-sm-4 control-label">Eligible Loan<strong
											...
											<div class="col-sm-4">
												<input name="totalEligibleAmt" placeholder="Enter"
										...
										<div class=" col-md-3"
											...
											<div class="box-body">
												...
												<div class="col-md-3">
													...
													<div class="text-center">
														<img id="goldImg" class="profile-user-img"
															src="upload_Files/${aadharPhoto}" alt="Image"
															style="height: 110px; width: 110px;"> <input
															type="file" name="filetag" id="filetag" />
													</div>
							...
							<div class="form-container" id="guarantorDetails" style="display: none;">
								...
								<div class="box-body form-horizontal">
									...
									<div class="clearfix">
										<button type="button" class="btn btn-default"
											onclick="backgoldsilverDetails()">PREVIOUS</button>
										<button type="button" class="btn btn-primary pull-right"
	...
	function backgoldsilverDetails() {
