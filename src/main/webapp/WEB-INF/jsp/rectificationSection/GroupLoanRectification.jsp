	...
	<div
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			...
			<section class="content-header">
				...
				<h5 style="margin-left: 18px;">JOINT LIABILITY UPDATE</h5>
				<ol class="breadcrumb">
						...
						<div class="col-md-12">
							...
							<div class="form-container">
								...
								<div class="box-body form-horizontal">
									<div class="col-md-6">
										<label class="col-sm-4 control-label">Select by Group
											Loan ID <strong style="color: Red">*</strong>
										</label>
										<div class="col-sm-8">
											<select name="id" id="id" class="form-control select2"
												onchange="GetGroupLoanIdForUpdate();" style="width: 100%;">
												<option selected="selected" value="">--Select Group
													Loan ID--</option>
											</select>
										</div>
									</div>
										...
										<div class="col-md-3">
											...
											<div class="col-sm-8">
												<select name="memberName" id="memberName"
													onchange="retrivigFeildsforMemberAjax();"
										...
										<div class="col-md-3">
											...
											<div class="col-sm-5">
												<div class="input-group date">
													...
													<input name="dob" type="" readonly="readonly" id="dob"
														class="form-control"
														data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;"
														data-mask="" />
												</div>
										...
										<div class="col-md-3">
											...
											<div class="col-sm-8">
												<select name="loanPlanName"
													onchange="retrivigFeildsforLoanNameAjax();"
										...
										<div class="col-md-3">
											...
											<div class="col-sm-8">
												<select name="planTerm" id="planTerm" class="form-control"
													style="width: 100%;">
													<option selected="selected" value="">--Select Plan
														Term--</option>
												</select>
											</div>
										</div>
										<div class="col-md-3">
											...
											<div class="col-sm-3">
												<input name="mode" type="text" readonly="readonly" id="mode"
													class="form-control" PlaceHolder="Mode" /> <span
										...
										<div class="col-md-3">
											...
											<div class="col-sm-3">
												<input name="loanROI" type="text" readonly="readonly"
													id="loanROI" class="form-control" PlaceHolder="ROI" /> <span
							...
							<div class="form-container">
								...
								<div class="box-body form-horizontal">
									...
									<div class="clearfix">
										<input type="button" name="updatebtnGroup" value="Update"
											id="updatebtnGroup"
