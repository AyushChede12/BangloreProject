	...
	<div
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			<section class="content-header">
				...
				<h5 style="margin-left: 18px;">POLICY DETAILS UPDATE</h5>
				<ol class="breadcrumb">
								...
								<div class="form-container">
									...
									<div class="box-body form-horizontal">
										...
										<div class="row four-field-row">
											...
											<div class="col-md-3">
												<label class="col-sm-4 control-label">Maturity Date
													<strong style="color: Red">*</strong>
												</label>
												<div class="col-sm-8">
													<div class="input-group date">
										...
										<div class="row four-field-row">
											<div class="col-md-3">
												<label class="col-sm-4 control-label">Policy Amount
													<strong style="color: Red">*</strong>
												</label>
												<div class="col-sm-8">
											...
											<div class="col-md-3">
												...
												<div class="col-sm-8">
													<input name="maturityAmount" type="text"
									...
									<div class="box-body form-horizontal">
										...
										<div class="clearfix">
											...
											<input type="submit" name="ctl00$ContentPlaceHolder1$btnSave"
												...
												type="submit" name="btnprint" value="Print" id="btnprint"
												class="btn btn-info pull-right margin-r-5"
												onclick="printTable1()" /> <input type="button"
