...
<body class="skin-blue sidebar-mini"
	...
	<form method="post" action="saveEmployeeMasterData"
		...
		<div
			...
			<div class="content-wrapper" style="min-height: 1105.75px;">
				<section class="content-header">
					...
					<h5 style="margin-left: 18px;">ADD TEAM MEMBER</h5>
					<ol class="breadcrumb">
				...
				<div class="wizard-steps">
					...
					<div class="wizard-step inactive" id="step2">
						...
						<div class="step-title">Qualification Details</div>
					</div>
					<div class="wizard-step inactive" id="step3">
						<div class="step-circle">3</div>
						<div class="step-title">Experience Details</div>
					</div>
				</div>
				<section class="content">
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-container" id="employeeDetails">
								...
								<div class="box-body form-horizontal">
									...
									<div class="clearfix">
										<button type="button" class="btn btn-primary pull-right"
											onclick="goqualificationDetails()">NEXT</button>
									</div>
								</div>
							</div>


							<div class="form-container" id="qualificationDetails" style="display: none;">
								<div class="box-header">
								...
								<div class="box-body form-horizontal">
									...
									<div class="clearfix">
										<button type="button" class="btn btn-default"
											onclick="backemployeeDetails()">PREVIOUS</button>
										<button type="button" class="btn btn-primary pull-right"
											onclick="goexperienceDetails()">NEXT</button>
									</div>
								</div>
							</div>

							<div class="form-container" id="experienceDetails" style="display: none;">
								<div class="box-header">
								...
								<div class="box-body form-horizontal">
									...
									<div class="clearfix">
										<button type="button" class="btn btn-default"
											onclick="backqualificationDetails()">PREVIOUS</button>
		...
		function goqualificationDetails() {
		...
		function backqualificationDetails() {
