	...
	<form method="post" action="updateSalaryPayment"
		...
		<div
			...
			<div class="content-wrapper" style="min-height: 1105.75px;">
				<section class="content-header">
					...
					<h5 style="margin-left: 18px;">SALARY PAYMENT</h5>
					<ol class="breadcrumb">
		...
		<script type="text/javascript">
			...
			var Page_Validators = new Array(
					...
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorPayDate"));
			//]]>
		</script>
		<script type="text/javascript">
			//<![CDATA[
			...
			var ContentPlaceHolder1_RequiredFieldValidatorPayDate = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatorPayDate"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorPayDate");
		...
		<script type="text/javascript">
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidator9').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidator10').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatorPayDate').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
