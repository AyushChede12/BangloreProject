	...
	<form method="post" action="saveEmployeeLeaveMaster"
		...
		<div
			...
			<div class="content-wrapper" style="min-height: 1105.75px;">
				<section class="content-header">
					...
					<h5 style="margin-left: 18px;">LEAVE ADJUSTMENT</h5>
					<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-container">
								...
								<div class="box-body form-horizontal">
									...
									<div class="row four-field-row">
										<div class="col-md-4">
											<label for="ddlEmployeeCode" class="col-sm-4 control-label">Employee
										...
										<div class="col-md-4">
											<label for="txtEmployeeName" class="col-sm-4 control-label">Employee
										...
										<div class="col-md-4">
											<label for="txtJoiningDate" class="col-sm-4 control-label">Joining
							...
							<div class="form-container">
								...
								<div class="box-body form-horizontal">
									<div class="col-md-4">
										<label for="txtCL" class="col-sm-4 control-label">Total
											CL</label>
										<div class="col-sm-8">
									...
									<div class="col-md-4">
										<label for="txtSL" class="col-sm-4 control-label">Total
											SL </label>
										<div class="col-sm-8">
									...
									<div class="col-md-4">
										<label for="txtPL" class="col-sm-4 control-label">Total
											EL/PL</label>
										<div class="col-sm-8">
							...
							<div class="form-container">
								...
								<div class="box-body form-horizontal">
									<div class="row four-field-row">
										<div class="col-md-4">
											<label for="txtCL" class="col-sm-4 control-label">CL</label>
											<div class="col-sm-6">
										...
										<div class="col-md-4">
											<label for="txtSL" class="col-sm-4 control-label">SL
											</label>
											<div class="col-sm-6">
										...
										<div class="col-md-4">
											<label for="txtPL" class="col-sm-4 control-label">EL/PL</label>
											<div class="col-sm-6">
							...
							<div class="form-container">
								...
								<div class="box-body form-horizontal">
									<div class="row four-field-row">
										<div class="col-md-4">
											<input id="cl" type="radio" name="leaveType" /> <label
												for="cl" class="radio-label"
												style="margin-left: 6px; cursor: pointer;">CL</label>
										</div>
										<div class="col-md-4">
											<input id="sl" type="radio" name="leaveType" /> <label
												for="sl" class="radio-label"
												style="margin-left: 6px; cursor: pointer;">SL</label>
										</div>
										<div class="col-md-4">
											<input id="el" type="radio" name="leaveType" /> <label
												for="el" class="radio-label"
												style="margin-left: 6px; cursor: pointer;">EL/PL</label>
										</div>
									</div>
									...
									<div class="">
										<div class="col-md-4">
											<input name="cl" type="text" maxlength="2" id="CL"
												...
												style="color: Red; display: none;">CL field Accepts
												only Numbers.</span>
										</div>
										<div class="col-md-4">
											<input name="sl" type="text" maxlength="2" id="SL"
												...
												style="color: Red; display: none;">SL field Accepts
												only Numbers.</span>
										</div>
										<div class="col-md-4">
											<input name="el" type="text" maxlength="2" id="EL"
												title="Enter Apply El/PL" class="form-control mb12"
												PlaceHolder="Enter El/PL" min="0" autocomplete="off" /> <span
												id="elMsg"
												style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Please
												Enter El/PL Leave Value</span> <span id="elMsg" class="col-md-12"
												style="color: Red; display: none;">El/PL field
								...
								<div class="box-body form-horizontal">
									...
									<div class="box-footer text-center">
										<button type="submit" name="submit" value="submit"
											class="btn btn-success margin-r-5">Submit</button>
										<button type="reset" name="ctl00$ContentPlaceHolder1$btnClear"
											value="Clear" id="ContentPlaceHolder1_btnClear"
											class="btn btn-success margin-r-5">Clear</button>
									</div>
								</div>
							</div>
							...
							<div class="form-container"
								...
								<div class="box-header">
									<h3 class="box-title">Leave Details Table</h3>
								</div>
								<div class="box-body form-horizontal">
									<div class="margin">
										<div>
		...
		<script type="text/javascript">
			...
			var Page_Validators = new Array(
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorEmployeeCode"),
					document
					...
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorLeaveDate"),
					document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorPurpose"));
			//]]>
		</script>
		<script type="text/javascript">
			//<![CDATA[
			var ContentPlaceHolder1_RequiredFieldValidatorEmployeeCode = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatorEmployeeCode"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorEmployeeCode");
			...
			var ContentPlaceHolder1_RegularExpressionValidator1 = document.all ? document.all["ContentPlaceHolder1_RegularExpressionValidator1"]
					: document
							.getElementById("ContentPlaceHolder1_RegularExpressionValidator1");
			...
			var ContentPlaceHolder1_RegularExpressionValidator2 = document.all ? document.all["ContentPlaceHolder1_RegularExpressionValidator2"]
					: document
							.getElementById("ContentPlaceHolder1_RegularExpressionValidator2");
			...
			var ContentPlaceHolder1_RegularExpressionValidator3 = document.all ? document.all["ContentPlaceHolder1_RegularExpressionValidator3"]
					: document
							.getElementById("ContentPlaceHolder1_RegularExpressionValidator3");
			...
			var ContentPlaceHolder1_RequiredFieldValidatorLeaveDate = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatorLeaveDate"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorLeaveDate");
			...
			var ContentPlaceHolder1_RequiredFieldValidatorPurpose = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidatorPurpose"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredFieldValidatorPurpose");
		...
		<script type="text/javascript">
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatorEmployeeCode').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RegularExpressionValidator1').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RegularExpressionValidator2').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RegularExpressionValidator3').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatorLeaveDate').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredFieldValidatorPurpose').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
