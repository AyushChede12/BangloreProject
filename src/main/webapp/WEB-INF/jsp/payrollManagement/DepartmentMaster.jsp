	...
	<form method="post" action="saveDepartmentMasterData"
		...
		<div
			...
			<div class="content-wrapper" style="min-height: 1105.75px;">
				<section class="content-header">
					...
					<h5 style="margin-left: 18px;">ADD DEPARTMENT</h5>
					<ol class="breadcrumb">
								...
								<div class="box-footer text-center">
									<div class="row col-md-12">
										<button type="button" name="clear" value="Clear" id="clear"
											class="btn btn-info" onclick="clearFieldsDepartment()">Clear</button>
		...
		<script type="text/javascript">
			...
			var Page_Validators = new Array(
					document
							.getElementById("ContentPlaceHolder1_RequiredtxtDepartmentName"));
			//]]>
		</script>
		<script type="text/javascript">
			//<![CDATA[
			var ContentPlaceHolder1_RequiredtxtDepartmentName = document.all ? document.all["ContentPlaceHolder1_RequiredtxtDepartmentName"]
					: document
							.getElementById("ContentPlaceHolder1_RequiredtxtDepartmentName");
		...
		<script type="text/javascript">
			...
			document
					.getElementById('ContentPlaceHolder1_RequiredtxtDepartmentName').dispose = function() {
				Array
						.remove(
								Page_Validators,
								document
