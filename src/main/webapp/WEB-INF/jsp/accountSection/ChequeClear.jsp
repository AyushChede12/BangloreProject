							...
							<div class="box-body">
								<div class="col-md-2">
									<div class="form-group">
										<label>Type :</label> <select name="paymentType"
											id="paymentType" class="form-control" style="width: 100%;">
								...
								<div class="col-md-2">
									<div class="form-group">
										<label>Branch :</label> <select name="branchType"
								...
								<div class="col-md-2">
									<div class="form-group">
										<label>Cheque No. :</label> <input name="chequeNo" type="text"
											id="chequeNo" class="form-control" Placeholder="Enter Cheque No."
											autocomplete="off" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label></label> <input type="submit"
											onclick="getSelectedChequeClears();"
