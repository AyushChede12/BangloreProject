...
<body class="skin-blue sidebar-mini" onload="GetBranchNameInTheDropDown(); GetLedgerMasterInTheDropDown();"
	...
	<div
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			...
			<section class="content-header">
				<h1 id="ContentPlaceHolder1_IdHeader">Regular Statement
					(Daybook)</h1>
				<ol class="breadcrumb">
						...
						<div class="box box-success">
							...
							<div class="box-footer">
								<div class="row col-md-12">
									<button type="submit" onclick="getSelectedDayBook();"
