							...
							<div class="box-body">
								<div class="col-md-3">
									<div class="form-group">
										<label>Select BranchName</label> <select name="branchName"
								...
								<div class="col-md-3">
									<div class="form-group">
										<label></label>
										<button type="submit" onclick="TrialBalance();"
											class="btn btn-success pull-right margin-20">View</button>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="box-header with-border">
								...
								<div>
									...
									<div style="font-weight: bold;">
										<p class="inline">Branch :</p>
										<p class="inline" id="Branch"></p>
										<br>
										<p class="inline">Date :</p>
										<p class="inline" id="FormDate"></p>
										<p class="inline">Between</p>
