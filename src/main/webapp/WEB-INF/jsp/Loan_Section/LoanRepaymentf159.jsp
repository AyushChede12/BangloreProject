		...
		<div
			...
			<div class="content-wrapper" style="min-height: 1105.75px;">
				<section class="content-header">
					...
					<h5 style="margin-left: 18px;">LOAN REPAYMENT</h5>
					<ol class="breadcrumb">
									...
									<div class="box-body">
										...
										<div class="col-md-6">
											...
											<select name="searchLoanId"
												onchange="displayLoanDetailsOfRegularEMIRepaymentSelectedId()"
							...
							<div class="box box-success form-container" id="loanSection">
								...
								<div class="box-body">
									<div class="col-md-3" style="margin-top: 15px;">
										...
										<label for="txtLoanDate">Loan Date <strong
										...
										<span id="ContentPlaceHolder1_RequiredFieldValidatorLoneDate"
											style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Enter
											Loan Date</span>
									</div>
									<div class="col-md-3" style="margin-top: 15px;">

										<label for="txtCodeName">Code & Name <strong
											style="color: Red">*</strong>
										</label> <input name="cspName" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtNameRelation">Relative Details </label> <input
											name="memberRelativesName" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtMobileNo">Mobile No <strong
											style="color: Red">*</strong>
										</label> <input name="phoneno" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtBranchName">Branch Name<strong
											style="color: Red">*</strong>
										</label> <input name="cspName" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtLoanPlanName">Plan Name <strong
											style="color: Red">*</strong>
										</label> <input name="loanName" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtPlanTerm">Term <strong
											style="color: Red">*</strong>
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtLoanMode">Loan Mode <strong
											style="color: Red">*</strong>
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtLoanAmount">Loan Amount <strong
											style="color: Red">*</strong>
										</label> <input name="loanAmount" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtLoanROI">Loan ROI <strong
											style="color: Red">*</strong>
										</label> <input name="ROI" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtTotalInterest">Total Interest <strong
											style="color: Red">*</strong>
										</label> <input name="totalInterest" type="text" readonly="readonly"
											id="totalInterest" class="form-control"
											PlaceHolder="Enter Total Interest" />

									</div>
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtTotalPrinciple">Total Principal <strong
											style="color: Red">*</strong>
										</label> <input name="totalPrinciple" type="text" readonly="readonly"
											id="totalPrinciple" class="form-control"
											PlaceHolder="Enter Total Principal" />

									</div>
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtTotalPayble">Total Payable <strong
											style="color: Red">*</strong>
										</label> <input name="totalPayble" type="text" readonly="readonly"
						...
						<div class="col-md-12">
							<div class="box box-danger form-container" id="paymentSection"
								...
								<div class="box-body">
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtTotalInterestDue">Interest Due <strong
											style="color: Red">*</strong>
										</label> <input name="totalInterestDue" type="text"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtTotalPrincipleDue">Principal Due <strong
											style="color: Red">*</strong>
										</label> <input name="totalPrincipleDue" type="text"
											readonly="readonly" id="totalPrincipleDue"
											class="form-control" PlaceHolder="Enter Total Principal Due" />
										<span
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtTotalDueAmt">Total Due Amt. <strong
											style="color: Red">*</strong>
										</label> <input name="totalDueAmt" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtDueDate">Due Date <strong
											style="color: Red">*</strong>
										</label>
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtPaymentBranch">Pay Branch<strong
											style="color: Red">*</strong>
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtAdvancePaid">Advance Paid <strong
											style="color: Red">*</strong>
										</label> <input name="advancePaid" type="text" readonly="readonly"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtPaymentdate">Pay Date <strong
											style="color: Red">*</strong>
										</label>
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<div class="col-md-6">
											<label for="ddlDeductLateFine">Deduct Fine<strong
												style="color: Red">*</strong>
											</label> <select name="deductLateFine" id="deductLateFine"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtPayableAmount">Pay Amount<strong
											style="color: Red">*</strong>
										</label> <input name="payableAmount" type="text" id="payableAmount"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										<label for="txtTotalPayableAmt">Net Amt.<strong
											style="color: Red">*</strong>
										</label> <input name="totalPayableAmt" type="text" readonly="readonly"
											id="totalPayableAmt" class="form-control"
											PlaceHolder="Enter Total Payable Amt." /> <span
									...
									<div id="ContentPlaceHolder1_uppaymode">
										<div class="col-md-3" style="margin-top: 15px;">
											<label for="drpPaymentBy">Pay By<strong
												style="color: Red">*</strong>
									...
									<div id="ContentPlaceHolder1_uppnkad">
										<div class="col-md-3" style="margin-top: 15px;">
											<label>Advisor Code<strong style="color: Red">*</strong></label>
										...
										<div class="col-md-3" style="margin-top: 15px;">
											<label>Advisor Name<strong style="color: Red">*</strong></label>
