	...
	<div
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			<section class="content-header">
				...
				<h5 style="margin-left: 18px;">GENERATE LOAN DOCUMENTS</h5>
				<ol class="breadcrumb">
							...
							<div class="box-body">
								...
								<div class="col-md-3" style="margin-top: 25px;">
									...
									<label></label> <input type="submit"
										onclick="searchNormalLoanDocument();" name="btnSave"
										value="Search" id="btnSave" class="btn btn-success margin-20" />
							...
							<div class="box-body">
								...
								<div class="col-md-3" style="margin-top: 15px;">
									...
									<label for="txtLoanPlanName">Plan Name <strong
										style="color: Red">*</strong>
									</label> <input name="loanPlanName" type="text" readonly="readonly"
								...
								<div class="col-md-3" style="margin-top: 15px;">
									...
									<label for="txtLoanMode">Loan Mode <strong
										style="color: Red">*</strong>
									</label> <input name="loanMode" type="text" readonly="readonly"
								...
								<div class="col-md-3" style="margin-top: 15px;">
									...
									<label for="txtLoanROI">Loan ROI <strong
										style="color: Red">*</strong>
									</label> <input name="ROI" type="text" readonly="readonly" id="ROI"
								...
								<div class="col-md-3" style="margin-top: 15px;">
									...
									<label for="txtROIType">ROI Type <strong
										...
										id="roiType" class="form-control" PlaceHolder="Enter ROI Type" />
								</div>
