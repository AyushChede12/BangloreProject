...
<body class="skin-blue sidebar-mini"
	...
	cz-shortcut-listen="true" onload="PolNoDropdown();getBranchName();">
		...
		<div class="content-wrapper" style="min-height: 1105.75px;">
			...
			<form id="myForm" name="myForm">
				<section class="content-header">
					...
					<h5 style="margin-left: 18px;">FULL MATURITY PAYMENT</h5>
					<ol class="breadcrumb">
								...
								<div class="box-body">
									...
									<div class="col-md-8" style="margin-top: 30px;">
										<button type="submit" name="btnupdate" value="Update"
											id="btnupdate" class="btn btn-success pull-right margin-r-5">Update</button>
									</div>
								...
								<div class="box-body">
									<div class="col-md-3" style="margin-top: 15px;">
										...
										<label>Policy No. :</label> <input name="policyNo1"
											...
											class="form-control" /> <span id="policyno"
											style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Enter
											Policy No</span>
									...
									<div class="col-md-3" style="margin-top: 15px;">
										...
										<label>Maturity Date :</label> <input name="maturitydate"
											type="date" readonly="readonly" id="maturitydate"
											class="form-control"
									...
									<div class="col-md-3" style="margin-top: 15px;">
										...
										<label>Adjustment (-) :</label> <input name="adjustment"
											type="text" readonly="readonly" id="adjustment"
											class="form-control" onpaste="return false"
											onkeypress="return isNumberKey(this, event);"
											autocomplete="off" />
									...
									<div class="col-md-3" style="margin-top: 15px;">
										...
										<div class="input-group date">
											...
											<input name="approvaldate" type="date" readonly="readonly"
								...
								<div class="box-body">
									<div class="col-md-3" style="margin-top: 15px;">
										...
										<label>Amount :</label> <input name="amount" type="text"
											id="amount" class="form-control" onpaste="return false"
											onkeypress="return isNumberKey(this, event);"
											autocomplete="off" style="color: Red; font-weight: bold;" />
										<span id="amount"
											style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Enter
											Amount</span>
									...
									<div class="col-md-3" style="margin-top: 15px;">
										...
										<label>Paid Amount :</label> <input name="paidamount"
											type="text" readonly="readonly" id="paidamount"
											class="form-control" onpaste="return false"
											onkeypress="return isNumberKey(this, event);"
											autocomplete="off" />
									...
									<div class="col-md-3" style="margin-top: 15px;">
										...
										<label>Due Amount :</label> <input name="dueamount"
											type="text" readonly="readonly" id="dueamount"
											class="form-control" onpaste="return false"
											onkeypress="return isNumberKey(this, event);"
											autocomplete="off" />
