...
<body class="skin-blue sidebar-mini" onload="getBranchName1();"
	style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);"
	cz-shortcut-listen="true">
	<!--  <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/MaturityTracking.aspx?Code=RR" id="form1"> -->
								...
								<div>
									...
									<table cellspacing="1" cellpadding="1" rules="all"
										...
										<tr style="color: White; background-color: #008385;">
											...
											<th scope="col">Applicant Branch</th>
											<th scope="col">Applicant Date</th>
	...
	<script src="dist/js/MatApplicationStatus.js"></script>

	<!--            </form> -->
</body>

<!-- Dk/Admin/MaturityTracking.aspx?Code=RR EDB D 09:27:20 GMT -->
</html>
