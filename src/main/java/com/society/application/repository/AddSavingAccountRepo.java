...
public interface AddSavingAccountRepo extends JpaRepository<AddSavingAccount, Integer> {
	...
	int updateTheAddSavingAcoount(@Param("accountNo") String accountNo,
			@Param("searchMemberCode") String searchMemberCode, @Param("opDate") String opDate,
			@Param("memberName") String memberName, @Param("dOB") String dOB,
			@Param("relativeName") String relativeName, @Param("phoneno") String phoneno,
			@Param("nomineeName") String nomineeName, @Param("nage") String nage, @Param("nRelation") String nRelation,
			@Param("address") String address, @Param("district") String district, @Param("cSPName") String cSPName,
			@Param("state") String state, @Param("pin") String pin, @Param("modeOfOp") String modeOfOp,
			@Param("jointCode") String jointCode, @Param("jointName") String jointName,
			@Param("jointRelation") String jointRelation, @Param("sBPlan") String sBPlan,
			@Param("openingAmount") String openingAmount, @Param("advisorCode") String advisorCode,
			@Param("advisorName") String advisorName, @Param("opFees") String opFees, @Param("paymode") String paymode,
			@Param("remarks") String remarks, @Param("chkisactive") String chkisactive,
			@Param("chkisSms") String chkisSms, @Param("chkdebitcard") String chkdebitcard,
	...
	int updateTheAddSavingAcoountWithoutFile(@Param("accountNo") String accountNo,
			@Param("searchMemberCode") String searchMemberCode, @Param("opDate") String opDate,
			@Param("memberName") String memberName, @Param("dOB") String dOB,
			@Param("relativeName") String relativeName, @Param("phoneno") String phoneno,
			@Param("nomineeName") String nomineeName, @Param("nage") String nage, @Param("nRelation") String nRelation,
			...
			@Param("advisorName") String advisorName, @Param("opFees") String opFees, @Param("paymode") String paymode,
			@Param("remarks") String remarks, @Param("chkisactive") String chkisactive,
			@Param("chkisSms") String chkisSms, @Param("chkdebitcard") String chkdebitcard, @Param("flag") String i,
