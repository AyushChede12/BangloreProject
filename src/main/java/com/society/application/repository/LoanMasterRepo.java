...
public interface LoanMasterRepo extends JpaRepository<LoanMaster, Integer> {
	...
	public int updateThroughID(@Param("loanDate") String loanDate, @Param("memberName") String memberName,
			@Param("branchName") String branchName, @Param("loanPlanName") String loanPlanName,
			@Param("planTerm") String planTerm, @Param("loanAmount") String loanAmount,
			@Param("loanPurpose") String loanPurpose, @Param("fileName1") String fileName1,
			@Param("fileName2") String fileName2, @Param("searchMemberCode") String searchMemberCode,
			@Param("securityType") String securityType, @Param("coApplicantCode") String coApplicantCode,
			@Param("securityDetails") String securityDetails, @Param("advisorCode") String advisorCode,
			@Param("flag") String flag, @Param("id") int id);
	...
	public int updateThroughID1(@Param("loanDate") String loanDate, @Param("memberName") String memberName,
			@Param("branchName") String branchName, @Param("loanPlanName") String loanPlanName,
			@Param("planTerm") String planTerm, @Param("loanAmount") String loanAmount,
			@Param("loanPurpose") String loanPurpose, @Param("searchMemberCode") String searchMemberCode,
			@Param("securityType") String securityType, @Param("coApplicantCode") String coApplicantCode,
			@Param("securityDetails") String securityDetails, @Param("advisorCode") String advisorCode,
			@Param("flag") String flag, @Param("id") int id);
	...
	public int updateThroughid(@Param("memberName") String memberName, @Param("branchName") String branchName,
			@Param("fileName1") String fileName1, @Param("fileName2") String fileName2,
			@Param("fileName3") String fileName3, @Param("loanPlanName") String loanPlanName,
			@Param("planTerm") String planTerm, @Param("loanAmount") String loanAmount,
			@Param("loanPurpose") String loanPurpose, @Param("karat") String karat, @Param("itemType") String itemType,
			@Param("itemName") String itemName, @Param("lockerLoc") String lockerLoc, @Param("purity") String purity,
			@Param("itemQty") String itemQty, @Param("itemWt") String itemWt, @Param("stonewt") String stonewt,
			@Param("searchMemberCode") String searchMemberCode, @Param("securityType") String securityType,
			@Param("coApplicantCode") String coApplicantCode, @Param("securityDetails") String securityDetails,
			@Param("id") int id);
