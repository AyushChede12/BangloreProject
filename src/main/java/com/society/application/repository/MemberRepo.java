...
public interface MemberRepo extends JpaRepository<Member, Integer> {
	...
	int updateThroughid(@Param("verifyWithAadhar") String verifyWithAadhar,
			@Param("registrationDate") String registrationDate, @Param("memberNamePrefix") String memberNamePrefix,
			@Param("memberName") String memberName, @Param("relativeName") String relativeName,
			@Param("relativeRelation") String relativeRelation, @Param("gender") String gender,
			@Param("dob") String dob, @Param("age") String age, @Param("maritalStatus") String maritalStatus,
			@Param("address") String address, @Param("district") String district, @Param("state") String state,
			@Param("branchName") String branchName, @Param("pinCode") String pinCode,
			@Param("aadharNo") String aadharNo, @Param("pan") String pan, @Param("voterNo") String voterNo,
			@Param("phoneno") String phoneno, @Param("emailid") String emailid, @Param("occupation") String occupation,
			@Param("education") String education, @Param("introMCode") String introMCode,
			@Param("introMName") String introMName, @Param("nomineeName") String nomineeName,
			@Param("getnRelation") String getnRelation, @Param("nomineeAddress") String nomineeAddress,
			@Param("nomineeKycNumber") String nomineeKycNumber, @Param("nomineeMobileNo") String nomineeMobileNo,
			@Param("nomineeAge") String nomineeAge, @Param("nomineePanNo") String nomineePanNo,
			@Param("nomineeKycType") String nomineeKycType, @Param("memberJoiningFess") String memberJoiningFess,
			@Param("shareAllotedfrm") String shareAllotedfrm, @Param("noOfShared") String noOfShared,
			@Param("enterShareAmount") String enterShareAmount, @Param("paymode") String paymode,
			@Param("remarks") String remarks, @Param("id") int id);
	...
	public int updateThroughselectByCode(@Param("selectByCode") String selectByCode,
			@Param("registrationDate") String registrationDate, @Param("memberNamePrefix") String memberNamePrefix,
			@Param("memberName") String memberName, @Param("relativeName") String relativeName,
			@Param("relativeRelation") String relativeRelation, @Param("gender") String gender,
			@Param("dob") String dob, @Param("age") String age, @Param("maritalStatus") String maritalStatus,
			...
			@Param("phoneno") String phoneno, @Param("emailid") String emailid, @Param("occupation") String occupation,
			@Param("education") String education, @Param("introMCode") String introMCode,
			@Param("introMName") String introMName, @Param("fileName1") String fileName1,
			@Param("nomineeName") String nomineeName, @Param("nRelation") String nRelation,
			@Param("nomineeAddress") String nomineeAddress, @Param("nomineeKycNumber") String nomineeKycNumber,
			@Param("nomineeMobileNo") String nomineeMobileNo, @Param("nomineeAge") String nomineeAge,
			@Param("nomineePanNo") String nomineePanNo, @Param("nomineeKycType") String nomineeKycType,
			@Param("memberJoiningFess") String memberJoiningFess, @Param("shareAllotedfrm") String shareAllotedfrm,
			@Param("noOfShared") String noOfShared, @Param("enterShareAmount") String enterShareAmount,
			@Param("paymode") String paymode, @Param("chkNo") String chkNo, @Param("chkDate") String chkDate,
			@Param("depositAcc") String depositAcc, @Param("remarks") String remarks);

	@Modifying
	@Transactional
	@Query("UPDATE Member SET flag =:flag WHERE selectByCode =:selectByCode")
	public int updateMemberRectificationThroughselectByCode(@Param("flag") String flag,
			@Param("selectByCode") String selectByCode);
