...
public class Advisor {
	...
	public String toString() {
		return "Advisor[id=" + id + ",DOJ=" + DOJ + ",SearchMemberCode=" + SearchMemberCode + ",MemberName="
				+ MemberName + ",DOB=" + DOB + "," + ",Age=" + Age + ",RelativeName=" + RelativeName
				+ ",relativeRelation=" + relativeRelation + ",phoneno=" + phoneno + ",nomineeName=" + nomineeName + ""
				+ ",nRelation=" + nRelation + ",cspName=" + cspName + ",nAge=" + nAge + ",address=" + address
				+ ",district=" + district + ",state=" + state + "," + ",pin=" + pin + ",occupation=" + occupation
				+ ",education=" + education + ",rank=" + rank + ",introducerCode=" + introducerCode + ","
				+ ",introName=" + introName + ",introRank=" + introRank + ",advisorFees=" + advisorFees + ",payMode="
				+ payMode + ",remarks=" + remarks + "," + ",isActive=" + isActive + ",isSms=" + isSms + "]";
	}
}
